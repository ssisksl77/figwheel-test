...
var or__26804__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj33691 = {"detail":data};
return obj33691;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26792__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26792__auto__)){
var and__26792__auto____$1 = goog.object.get(window,"CustomEvent");
...
var args33696 = [];
var len__27879__auto___33702 = arguments.length;
var i__27880__auto___33703 = (0);
while(true){
if((i__27880__auto___33703 < len__27879__auto___33702)){
args33696.push((arguments[i__27880__auto___33703]));

var G__33704 = (i__27880__auto___33703 + (1));
i__27880__auto___33703 = G__33704;
continue;
} else {
}
break;
...
var f = (function (){var pred__33699 = cljs.core._EQ_;
var expr__33700 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33699.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33700))){
return ((function (pred__33699,expr__33700){
return (function (p1__33692_SHARP_){
return console.warn(p1__33692_SHARP_);
});
;})(pred__33699,expr__33700))
} else {
if(cljs.core.truth_(pred__33699.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33700))){
return ((function (pred__33699,expr__33700){
return (function (p1__33693_SHARP_){
return console.debug(p1__33693_SHARP_);
});
;})(pred__33699,expr__33700))
} else {
if(cljs.core.truth_(pred__33699.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33700))){
return ((function (pred__33699,expr__33700){
return (function (p1__33694_SHARP_){
return console.error(p1__33694_SHARP_);
});
;})(pred__33699,expr__33700))
} else {
return ((function (pred__33699,expr__33700){
return (function (p1__33695_SHARP_){
return console.log(p1__33695_SHARP_);
});
;})(pred__33699,expr__33700))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33706){
var map__33709 = p__33706;
...
var opts = map__33709__$1;
var eval_fn = cljs.core.get.call(null,map__33709__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33711_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33713,(0),null);
var v = cljs.core.nth.call(null,vec__33713,(1),null);
...
var args33716 = [];
var len__27879__auto___33720 = arguments.length;
var i__27880__auto___33721 = (0);
while(true){
if((i__27880__auto___33721 < len__27879__auto___33720)){
args33716.push((arguments[i__27880__auto___33721]));

var G__33722 = (i__27880__auto___33721 + (1));
i__27880__auto___33721 = G__33722;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__26792__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1511752908921