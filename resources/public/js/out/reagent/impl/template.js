...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27410__auto__,writer__27411__auto__,opt__27412__auto__){
return cljs.core._write.call(null,writer__27411__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__29764 = o;
(G__29764[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__29765__delegate = function (args){
...
while (G__29766__i < G__29766__a.length) {G__29766__a[G__29766__i] = arguments[G__29766__i + 0]; ++G__29766__i;}
  args = new cljs.core.IndexedSeq(G__29766__a,0);
} 
...
var args = cljs.core.seq(arglist__29767);
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__29770){
var map__29773 = p__29770;
...
var props = map__29773__$1;
var class$ = cljs.core.get.call(null,map__29773__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__29775){
...
var on_write = cljs.core.get.call(null,map__29778__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__29778,map__29778__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__29778,map__29778__$1,on_write))
);
} else {
...
var args29781 = [];
var len__27879__auto___29788 = arguments.length;
var i__27880__auto___29789 = (0);
while(true){
if((i__27880__auto___29789 < len__27879__auto___29788)){
args29781.push((arguments[i__27880__auto___29789]));

var G__29790 = (i__27880__auto___29789 + (1));
i__27880__auto___29789 = G__29790;
continue;
} else {
}
break;
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__29784){
...
var synthetic_on_update = cljs.core.get.call(null,map__29785__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__29785__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__26792__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26792__auto__){
var and__26792__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__29787 = jsprops;
(G__29787["defaultValue"] = value);

(G__29787["onChange"] = ((function (G__29787,v,value,on_change,on_change__$1,map__29785,map__29785__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__29780_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__29780_SHARP_);
});})(G__29787,v,value,on_change,on_change__$1,map__29785,map__29785__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__29798 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29798,(0),null);
var id = cljs.core.nth.call(null,vec__29798,(1),null);
var class$ = cljs.core.nth.call(null,vec__29798,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___29803 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___29803 == null)){
} else {
var key_29804 = temp__4661__auto___29803;
(jsprops["key"] = key_29804);
}
...
var args29805 = [];
var len__27879__auto___29815 = arguments.length;
var i__27880__auto___29816 = (0);
while(true){
if((i__27880__auto___29816 < len__27879__auto___29815)){
args29805.push((arguments[i__27880__auto___29816]));

var G__29817 = (i__27880__auto___29816 + (1));
i__27880__auto___29816 = G__29817;
continue;
} else {
}
break;
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__29808){
var map__29809 = p__29808;
var map__29809__$1 = ((((!((map__29809 == null)))?((((map__29809.cljs$lang$protocol_mask$partition0$ & (64))) || (map__29809.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29809):map__29809);
var synthetic_input = cljs.core.get.call(null,map__29809__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__29811 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__29811["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__29812 = wrapped;
(G__29812["syntheticInput"] = true);

return G__29812;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__29813 = wrapped__$1;
(G__29813["syntheticOnChange"] = on_change);

return G__29813;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__29814 = wrapped__$2;
(G__29814["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__26804__auto__ = synthetic_input;
...
var len__27879__auto___29824 = arguments.length;
var i__27880__auto___29825 = (0);
while(true){
if((i__27880__auto___29825 < len__27879__auto___29824)){
args__27886__auto__.push((arguments[i__27880__auto___29825]));

var G__29826 = (i__27880__auto___29825 + (1));
i__27880__auto___29825 = G__29826;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27887__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29822){
var G__29823 = cljs.core.first.call(null,seq29822);
var seq29822__$1 = cljs.core.next.call(null,seq29822);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__29823,seq29822__$1);
});
...
break;
default:
var G__29830 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29830;
continue;
...
var n__27719__auto___29833 = a.length;
var i_29834 = (0);
while(true){
if((i_29834 < n__27719__auto___29833)){
(a[i_29834] = reagent.impl.template.as_element.call(null,(a[i_29834])));
...
var a = cljs.core.into_array.call(null,s);
var n__27719__auto___29836 = a.length;
var i_29837 = (0);
while(true){
if((i_29837 < n__27719__auto___29836)){
var val_29838 = (a[i_29837]);
if((cljs.core.vector_QMARK_.call(null,val_29838)) && ((reagent.impl.template.key_from_vec.call(null,val_29838) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29837] = reagent.impl.template.as_element.call(null,val_29838));

var G__29839 = (i_29837 + (1));
i_29837 = G__29839;
continue;
} else {
}
...
var ctx = ({});
var vec__29844 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29844,(0),null);
var derefed = cljs.core.nth.call(null,vec__29844,(1),null);
...
var G__29848 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29848) {
case (0):
...
break;
default:
return react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__29848){
...
//# sourceMappingURL=template.js.map?rel=1511941498999